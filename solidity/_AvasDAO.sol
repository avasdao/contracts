...
/*******************************************************************************
 *
 * BCHPleaseDb Interface
 */
interface BCHPleaseDbInterface {
    /* Interface getters. */
...
contract ServiceName is Owned {
    ...
    /* Initialize BCHPlease Db contract. */
    BCHPleaseDbInterface private _bchPleaseDb;
     ...
     *       BCHPleaseDb keys; in order to prevent ANY accidental or
     ...
     */
    constructor() {
        /* Initialize BCHPleaseDb (eternal) storage database contract. */
        // NOTE We hard-code the address here, since it should never change.
        // _bchPleaseDb = BCHPleaseDbInterface(0x1D0847fB7f168a6011D756F5F3835E0acfA7F1fd); // SmartBCH | SBCH
        // _bchPleaseDb = BCHPleaseDbInterface(0x806f9f901EB26A208c2b88Fc36C7Cc8acc6fb45e); // Amber Testnet

        /* Initialize (aname) hash. */
        bytes32 hash = keccak256(abi.encodePacked('aname.', _namespace));

        /* Set predecessor address. */
        _predecessor = _bchPleaseDb.getAddress(hash);
    ...
    /**
     * @dev Only allow access to an authorized BCHPlease administrator.
     */
    modifier onlyAuthByBCHPlease() {
        /* Verify write access is only permitted to authorized accounts. */
        require(_bchPleaseDb.getBool(keccak256(
    ...
    ) onlyAuthByBCHPlease external returns (bool success) {
    ...
    function _ecRecovery() private view returns (
        ...
        /* Retrieve value from BCHPlease Db. */
        address aname = _bchPleaseDb.getAddress(hash);
